...
[![Main Tech Stack](https://skillicons.dev/icons?i=py,bash,docker,githubactions,js,html,css,tailwind,npm,nodejs,react,express,postgres,postman,vite,sass,terraform,aws&perline=7)](https://skillicons.dev)
